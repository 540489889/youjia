<template>
  <ul>
    <li> <cube-input v-model="inputTell" placeholder="输入帐号" :clearable="clearable"></cube-input></li>
    <li>
      <cube-input v-model="inputPwd"   :type="type" :eye="eye" placeholder="输入密码"></cube-input>
    </li>
    <li class="registerLi">
